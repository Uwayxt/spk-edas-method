        ...
        <form action={{ route('major.store') }} method="POST">
            ...
            <div class="flex flex-col gap-4 sm sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="value" id="value" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="0.2" required="">
                </div>
                <div class="w-full">
